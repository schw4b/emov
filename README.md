...
Now, let's do a full search across all possible parent models of ![Formula](http://www.sciweavers.org/tex2img.php?eq=2%5E%7Bn-1%7D&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt="2^{n-1}" width="40" height="18" />). Here, with n=5, we have 16 possible models.
